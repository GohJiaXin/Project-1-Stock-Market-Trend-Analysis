...
#     manual_upward, manual_downward, longest_up, longest_down = manual_trend(data)
...
#     print(f"Longest Upward Streak: {longest_up}, Longest Downward Streak: {longest_down}")
...
#         # Plot candlestick chart with trend markers
...
#             type='candle',
#             style=s,
#             title=f"{ticker_symbol} Candlestick Chart with Up/Down Trend Markers",
#             ylabel='Price',
#             volume=True,
